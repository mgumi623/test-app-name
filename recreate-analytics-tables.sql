/*
このSQLファイルは分析システムのテーブルを完全に再作成します：

テーブル構成：
1. analytics_sessions: セッション情報の管理
   - ユーザー情報、デバイス情報
   - セッション開始/終了時間

2. analytics_events: ユーザーアクション追跡
   - ページビュー、クリック、チャットなどのイベント
   - イベントの詳細データをJSON形式で保存

3. analytics_errors: エラー情報の記録
